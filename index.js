...
var W = heroContainer.getBoundingClientRect().width;
var H = heroContainer.offsetHeight;
canvas.width = W;
canvas.height = H;
...
function onWindowResize () {
    W = heroContainer.getBoundingClientRect().width;
    H = heroContainer.offsetHeight;
    canvas.width = W;
    canvas.height = H;
}
